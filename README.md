...
A __React Native__ / __Redux__ app where users can create groups, chat, share pictures, and like posts. Users can take pictures directly from the app, and other users are notified to the new message via push notifications. It uses __Google Cloud__ for authentication, __Firestore__ for chat data and group metadata (likes, title, members, etc.), and __Cloud Storage__ for images. My family used this app to document building our back deck.
